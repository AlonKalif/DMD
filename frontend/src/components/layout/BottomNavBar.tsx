...
const navLinkClass = ({ isActive }: { isActive: boolean }) =>
    clsx(
        'flex flex-1 items-center justify-center py-1.5 px-2 text-sm font-semibold font-blackletter transition-colors',
        isActive
...
export function BottomNavBar() {
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-20 flex h-10 items-stretch leather-card border-t border-paladin-gold/30">
