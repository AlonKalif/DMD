...
func (h *MediaAssetsHandler) Post(w http.ResponseWriter, r *http.Request) {
    ...
    if err := h.repo.CreateMediaAsset(&newAsset); err != nil {
        common.RespondWithError(w, common.NewInternalError("Failed to create media asset", err))
        return
    }
    common.RespondWithJSON(w, http.StatusCreated, newAsset)
}
...
func (h *MediaAssetsHandler) Put(w http.ResponseWriter, r *http.Request) {
    ...
    if err = h.repo.UpdateMediaAsset(&updatedAsset); err != nil {
        common.RespondWithError(w, common.NewInternalError("Failed to update media asset", err))
        return
    }
    common.RespondWithJSON(w, http.StatusOK, updatedAsset)
}
...
func (h *MediaAssetsHandler) Delete(w http.ResponseWriter, r *http.Request) {
    ...
    if err = h.repo.DeleteMediaAsset(id); err != nil {
        common.RespondWithError(w, common.NewInternalError("Failed to delete media asset", err))
        return
    }
...
func (h *MediaAssetsHandler) getAllMediaAssets(w http.ResponseWriter, r *http.Request) {
    ...
    filters := common.MediaAssetFilters{
    ...
    if err != nil {
        common.RespondWithError(w, common.NewInternalError("Failed to get media assets", err))
        return
    }
    common.RespondWithJSON(w, http.StatusOK, assets)
}
...
func (h *MediaAssetsHandler) getMediaAssetByID(w http.ResponseWriter, r *http.Request) {
    ...
    if err != nil {
        appErr := common.NewInternalError("Failed to get asset by id", err)
    ...
    common.RespondWithJSON(w, http.StatusOK, asset)
}
